...
def main():
    pygame.init()
    pygame.display.set_icon(pygame.image.load("resources\images\ico.jpg"))
    screen=pygame.display.set_mode([700,600])
    pygame.display.set_caption("Elements_Balls")
    mainBackground=pygame.image.load("resources\images\\newMain.jpg")
    standByBackground=pygame.image.load("resources\images\standBy.jpg")
    gameEnd=pygame.image.load("resources\images\gameEnd.jpg")
    ...
    while ejecutar:
        ...
        if caso==2:
            if soundsCaso2==1:
                ...
                screen.blit(pygame.image.load("resources\images\LeafBall1.jpg"),(60,100))
                screen.blit(pygame.image.load("resources\images\EarthBall1.jpg"),(270,100))
                screen.blit(pygame.image.load("resources\images\WaterBall1.jpg"),(470,100))
                screen.blit(pygame.image.load("resources\images\DarkBall1.jpg"),(60,350))
                screen.blit(pygame.image.load("resources\images\FireBall1.jpg"),(270,350))
                screen.blit(pygame.image.load("resources\images\LigthBall1.jpg"),(470,350))
                soundsCaso2+=1
            if soundsCaso2==2:
                if numAyuda==1:
                    pygame.mixer.quit()
