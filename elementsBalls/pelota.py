...
class pelota(pygame.sprite.Sprite):
    def __init__(self):
        self.imagen=pygame.image.load("resources\images\FireBall1.jpg")
    ...
    def cambiarImagen(self,tipo):
        ...
        if tipo==2:
            if self.choose==0:
                ...
                sound.play()
                self.choose=1
            self.imagen=pygame.image.load("resources\images\DarkBall1.jpg")
            self.tipo=2
        if tipo==3:
            if self.choose==0:
                sound=pygame.mixer.Sound("resources\sounds\\choose.wav")
                sound.play()
                self.choose=1
            self.imagen=pygame.image.load("resources\images\WaterBall1.jpg")
            self.tipo=3
        if tipo==4:
            if self.choose==0:
                sound=pygame.mixer.Sound("resources\sounds\\choose.wav")
                sound.play()
                self.choose=1
            self.imagen=pygame.image.load("resources\images\LeafBall1.jpg")
            self.tipo=4
        if tipo==5:
            if self.choose==0:
                sound=pygame.mixer.Sound("resources\sounds\\choose.wav")
                sound.play()
                self.choose=1
            self.imagen=pygame.image.load("resources\images\LigthBall1.jpg")
            self.tipo=5
        if tipo==6:
            if self.choose==0:
                sound=pygame.mixer.Sound("resources\sounds\\choose.wav")
                sound.play()
                self.choose=1
            self.imagen=pygame.image.load("resources\images\EarthBall1.jpg")
            self.tipo=6
        if tipo==7:
            self.imagen=pygame.image.load("resources\images\FireBall2.jpg")
            self.tipo=7
